...
data = pd.read_csv('D:/Coventry/Semster-1/Information retrieval/CourseWork/trainingdata.csv')
dataCopy = data
data.head()
...
with open('D:/Coventry/Semster-1/Information retrieval/CourseWork/coventryScholar.json') as f:
    dataj = json.load(f)
...
df.to_json('ClassificationDoc.json', orient="records")
